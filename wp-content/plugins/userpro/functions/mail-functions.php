	...
	function userpro_mail($id, $template=null, $var1=null, $form=null) {
		...
		if ($template == 'newaccount' && !$userpro->is_pending($user->ID) ) {
	        ...
	        if( pll_current_language() == 'en' ){
	        	$subject = 'Music Pro Awards 2016';
	        	include plugin_dir_path( __FILE__ ).'/mail-templates/ppm_welcome_message_EN.php';
			}else{
				$subject = userpro_get_option('mail_admin_newaccount_s');
				include plugin_dir_path( __FILE__ ).'/mail-templates/ppm_welcome_message_PT.php';
			}
